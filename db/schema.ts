...
export const challenges = pgTable("challeges",{
    id:serial("id").primaryKey(),
    lessonId : integer("lesson_id").
    references(()=>lessons.id,{onDelete : 'cascade'}).notNull(),
...
export const challengeOptions = pgTable("challege_options",{
    id:serial("id").primaryKey(),
    challengeId : integer("challenge_id").
    references(()=>challenges.id,{onDelete : 'cascade'}).notNull(),
...
export const userSubscription = pgTable("user_subscription",{
    ...
    stripeCurrentPeriodEnd : timestamp("stripe_currect_period_end").notNull(),
